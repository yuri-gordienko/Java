...
public final class ExceptionUtil {
    ...
    public static final String TOUR_IS_NOT_PRESENT = "Tour is not present";
    public static final String USERNAME_NOT_FOUND_EXCEPTION = "Invalid username or password";
