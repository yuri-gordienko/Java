...
//
//        Багатовимірні масиви корисні, коли потрібно зберігати дані в табличній формі, як-от таблиця з рядками та стовпцями.
//
...
//        Ми також можемо використовувати for loopвсередині іншого for loop, щоб отримати елементи двовимірного масиву (ми все ще повинні вказувати на два індекси):
//
//        приклад
//        int[][] myNumbers = { {1, 2, 3, 4}, {5, 6, 7} };
