...
--tour_variants
--rout
insert into tour_variants values (1, '7 діб', '14 діб', 'Групове харчування у місті розташування', '15 200 грн.', '27 360 грн.', 'Згідно з старовинною легендою, коли Господь розподіляв багатства земних надр, на країну в самому серці Європи, Швейцарію їх не вистачило. Щоб виправити цю несправедливість, Бог подарував їй високі гори, сяючі льодовики, бурхливі водоспади, мальовничі долини, найкрасивіші річки та найчистіші блакитні озера. Надзвичайно прекрасні види Швейцарії приваблюють тисячі туристів, це ніби особливий чарівний світ, що змушує повірити в те, що рай існує.', 1);
insert into tour_variants values (2, '7 діб', '14 діб', 'Групове харчування у місті розташування', '12 540 грн.', '21 320 грн.', 'Казкова Італія, пам`ятки якої мовчазно свідчать про багату історію, викликає величезний інтерес у мандрівників. Ми представляємо найзнаменитіші та найдавніші її міста - Рим, Мілан, Флоренція, Венеція. Їхня велична краса нікого не залишає байдужим. Але щоб відчути неповторний італійський колорит, потрібно зійти з вторинних туристичних стежок та дослідити маленькі затишні містечка. Тут дбайливо зберігають справжню культуру та традиції країни.',2);
insert into tour_variants values (3, '7 діб', '14 діб', 'Групове харчування у місті розташування', '12 950 грн.', '22 100 грн.', 'Природа Іспанії дуже контрастна через рельєфні особливості. Різноманітність природних пейзажів, якими вирізняється Іспанія, вражає. Гори, ліси та долини, вулкани, дюни та пустелі, озера, а також водно-болотні угіддя, море, скелясті береги, водоспади та ущелини.',3);
insert into tour_variants values (4, '7 діб', '14 діб', 'Групове харчування у місті розташування', '17 860 грн.', '30 300 грн.', 'Франція – одна з найчарівніших і найпрекрасніших країн Європи. І окрім культурної спадщини, країна багата на рідкісні мальовничі пейзажі.  Природні умови Франції досить різноманітні. Тут можна знайти буквально все – прибережні рівнини, обширні долини річок, оточені живописними горбами, невисокі гірські ланцюги, високі гірські масиви Альп, а також старовинні замки.', 4);
insert into tour_variants values (5, '7 діб', '14 діб', 'Групове харчування у місті розташування', '19 760 грн.', '33 600 грн.', 'Шотландська природа вже давно вражає кожного туриста, що приїжджає сюди. Ця невелика країна має багату історію та дуже гарну природу. Шотландські пейзажі дуже різноманітні: гірські річки з водоспадами, чисті озера, болота, суворі гори та перевали, горбисті долини, хвойні ліси, мальовниче узбережжя, альпійські луки, фіорди, численні острови.', 5);
insert into tour_variants values (6, '7 діб', '14 діб', 'Групове харчування у місті розташування', '21 660 грн.', '36 800 грн.', 'Норвегія – неймовірна країна, яка може похвалитися незайманою природою: від розлогих фіордів та льодовиків до наймальовничіших берегів та зелених пасовищ. Природа Норвегії – це світ, повністю сформований суворим північним кліматом, північними морями та горами. Держава розташована за Полярним колом. З травня до липня в Норвегії – полярний день, з осені до ранньої весни панує полярна ніч, яку розцвічує полярне сяйво.', 6);
...
--tour_videos
insert into tour_videos values (1, 'https://www.youtube.com/embed/vlDzYIIOYmM');
insert into tour_videos values (2, 'https://www.youtube.com/embed/vlDzYIIOYmM');
insert into tour_videos values (3, 'https://www.youtube.com/embed/vlDzYIIOYmM');
insert into tour_videos values (4, 'https://www.youtube.com/embed/vlDzYIIOYmM');
insert into tour_videos values (5, 'https://www.youtube.com/embed/vlDzYIIOYmM');
insert into tour_videos values (6, 'https://www.youtube.com/embed/vlDzYIIOYmM');
