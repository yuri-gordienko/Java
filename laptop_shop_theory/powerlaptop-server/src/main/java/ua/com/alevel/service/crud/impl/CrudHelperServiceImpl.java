...
public class CrudHelperServiceImpl<E extends BaseEntity, R extends BaseEntityRepository<E>>
    ...
    @Override
    public void checkExists(Long id, R repository) {    // проверяем наличие
        if (!repository.existsById(id)) {
            throw new EntityNotFoundException("Entity not found");  // если нет продукта кидаем эксепшн
        }
    }
    ...
    public E findById(Long id, R repository) {
        ...
        // если нет продукта кидаем эксепшн
    }
